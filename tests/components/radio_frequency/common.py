...
Vendored verbatim from home-assistant/core ``tests/components/radio_frequency/
common.py`` (dev branch, fetched 2026-05-15). When the integration is ported
into the core repo this whole file is dropped and the import path becomes
``tests.components.radio_frequency.common`` for free.
"""
